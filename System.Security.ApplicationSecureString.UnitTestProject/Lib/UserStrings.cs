...
namespace UnitTestProject {
    public static class UserStrings {
        ...
        [DebuggerStepThrough]
        public static IEnumerable<String> GetUserStrings(Assembly assembly) {
            return (new MetaDataReader(assembly.Location)).EnumerateUserStrings();
        }

        [DebuggerStepThrough]
        public static IEnumerable<String> GetUserInternedStrings(Assembly assembly) {
            return GetUserStrings(assembly).Where(x => string.IsInterned(x) != null);
        }

        [DebuggerStepThrough]
        public static IEnumerable<String> GetUserNonInternedStrings(Assembly assembly) {
            return GetUserStrings(assembly).Where(x => string.IsInterned(x) == null);
        }
        ...
        internal class MetaDataReader {
            ...
            private uint GetUserStringLength(uint id) {
                uint length;
            ...
            private string GetUserStringContent(uint id, uint length) {
            ...
            private IEnumerable<uint> EnumerateUserStringIds() {
            ...
            private static void AssertHresultIsZero(uint hr) {
                if (hr != 0) {
